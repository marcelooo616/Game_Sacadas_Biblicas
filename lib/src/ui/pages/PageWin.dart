...
class PageWin extends StatelessWidget {
  const PageWin({Key? key}) : super(key: key);
          ...
          children: [
            Container(
              ...
              child: Container(
                ...
                child: Image.asset("assets/images/bgcopiar.png"),
              ),
            ),
            Row(
              ...
              children: [
                ...
                decoration: BoxDecoration(
                  ...
                  child: Text("Score:  ${gameProvider.totalAmountFinal}",
                  style: TextStyle(
                    fontSize: 25,
